...
def index(request):
    if request.method == 'POST':
        ...
        if formOne.is_valid() and formTwo.is_valid() and reportForm.is_valid():
    ...
    return render(request, 'reliability/index.html', {'formOne': formOne, 'formTwo': formTwo, 'reportForm': reportForm})
